...
class ManagementControllerTest {
    ...
    void createDefinition_returns409WhenConflict() throws Exception {
        ProcessDefinitionRequest req = new ProcessDefinitionRequest("EXISTING", "STEP_1", Map.of());
    ...
    void listProcesses_returns200() throws Exception {
        ...
        PageImpl<ProcessInstanceResponse> page = new PageImpl<>(List.of(sampleInstance(id, ProcessStatus.RUNNING)));
