...
public class ProcessInstance {
    ...
    /** Step to dispatch once all parallel branches have completed. Null when not in a fork. */
    @Column(name = "join_step")
    private String joinStep;

    /** JSON array of eventTypes already received during parallel wait (for idempotency). */
    ...
    public Integer getParallelPending() { return parallelPending; }
    public String getJoinStep() { return joinStep; }
    public String getParallelCompleted() { return parallelCompleted; }
    ...
    public void setParallelPending(Integer parallelPending) { this.parallelPending = parallelPending; }
    public void setJoinStep(String joinStep) { this.joinStep = joinStep; }
    public void setParallelCompleted(String parallelCompleted) { this.parallelCompleted = parallelCompleted; }
}
