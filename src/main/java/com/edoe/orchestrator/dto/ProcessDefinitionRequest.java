...
public record ProcessDefinitionRequest(
                ...
                @Schema(description = "Map of event type to ordered list of conditional branches. Branches are evaluated top-to-bottom; first match wins. A null condition is an unconditional default.") Map<String, List<TransitionRule>> transitions,
